          ...
          <div class="row">
            <div class="col-md-4 ftco-animate">
              <div class="work-entry">
                <a href="table1.php?floor=1" class="img" style="background-image: url(../images/work-1.jpg);">
            ...
            <div class="col-md-4 ftco-animate">
              <div class="work-entry">
                <a href="table1.php?floor=2" class="img" style="background-image: url(../images/work-2.jpg);">
                  <div class="text d-flex justify-content-center align-items-center">
                    <div class="p-3">
            ...
            <div class="col-md-4 ftco-animate">
              <div class="work-entry">
                <a href="table1.php?floor=3" class="img" style="background-image: url(../images/work-3.jpg);">
                  <div class="text d-flex justify-content-center align-items-center">
                    <div class="p-3">
            ...
            <div class="col-md-4 ftco-animate">
              <div class="work-entry">
                <a href="table1.php?floor=4" class="img" style="background-image: url(../images/work-4.jpg);">
                  <div class="text d-flex justify-content-center align-items-center">
                    <div class="p-3">
                      <span>Sirkulasi</span>
                      <h3>Lantai 04</h3>
            ...
            <div class="col-md-4 ftco-animate">
              <div class="work-entry">
                <a href="table1.php?floor=5" class="img" style="background-image: url(../images/work-5.jpg);">
                  <div class="text d-flex justify-content-center align-items-center">
                    <div class="p-3">
                      <span>Otomasi</span>
                      <h3>Lantai 05</h3>
            ...
            <div class="col-md-4 ftco-animate">
              <div class="work-entry">
                <a href="table1.php?floor=6" class="img" style="background-image: url(../images/work-6.jpg);">
                  <div class="text d-flex justify-content-center align-items-center">
                    <div class="p-3">
            ...
            <div class="col-md-4 ftco-animate">
              <div class="work-entry">
                <a href="table1.php?floor=7" class="img" style="background-image: url(../images/work-2.jpg);">
                  <div class="text d-flex justify-content-center align-items-center">
                    <div class="p-3">
                      <span>American Corner</span>
                      <h3>Lantai 07</h3>
                    </div>
                  </div>
                </a>
