   ...
   <body>
    ...
    <div class="row justify-content-center mb-5 pb-5">
      <div class="col-md-7 text-center heading-section ftco-animate">
        <h2 class="mb-2">Edit Data Akun</h2>
        <span class="subheading">Satisfaction Survey System</span>


        <form action="../db/edit2.php" method="post">
        <table align="center" border="0">
        <input type="hidden" name="id" value="<?php echo $buff['id'];?> "/>
          <tr>
            <td align="left" width="150">nama depan</td>
            <td align="left" width="200"><input type="text" name="namadep" value="<?php echo $buff['namadep'];?>"></td>
          </tr>
          <tr>
            <td align="left">nama belakang</td>
            <td align="left"><input type="text" name="namabel" value="<?php echo $buff['namabel'];?>"></td>
          </tr>
          <tr>
            <td align="left">username</td>
            <td align="left"><input required="required" type="text" name="username" value="<?php echo $buff['username'];?>"></td>
          </tr>
          <tr>
            <td align="left">password</td>
            <td align="left"><input required="required" type="password" name="password" value="<?php echo $buff['password'];?>"></td>
          </tr>
          <tr>
            <td align="left">Alamat</td>
            <td align="left"><textarea cols=30 rows=3 name="alamat"><?php echo $buff['alamat'];?></textarea></td>
          </tr>
          <tr>
            <td align="left">email</td>
            <td align="left"><input type="text" name="email" value="<?php echo $buff['email'];?>"></td>
          </tr>
          <tr>
            <td align="left">no telpon</td>
            <td align="left"><input type="text" name="notel" value="<?php echo $buff['notel'];?>"></td>
          </tr>
          <tr>
          ...
          <tr>
            <td></td>
            <td align="left" height="130"><input type="submit" value="Submit" /> <input type="reset" value="Reset" /></td>
          </tr>
        </table>
        </form>
