...
<?php
session_start();
if(($_SESSION['islogin']!=true)||($_SESSION["level"]!='operator2')){
 ...
 <html>
   ...
   <body>
      <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
        <div class="container">
          <a class="navbar-brand" href="lantai2.php">Pusat Perpustakaan - Lantai 2</a>
          ...
          <div class="container">
            <div class="row d-flex justify-content-center ftco-animate">
              <div class="col-md-7 text-center heading-section heading-section-white ftco-animate">
                ...
                <h2><?php
                $sql ="SELECT * from question where id_text=4";
              ...
              <h2>
                <?php
                $sql ="SELECT * from question where id_text=5";
                $query = mysqli_query($con,$sql);
                $buff=mysqli_fetch_array($query);
                echo $buff ['text'];?>
                </h2>
